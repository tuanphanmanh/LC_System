...
export class CreateMassNotificationModalComponent extends AppComponentBase {
  ...
  onTargetNotifiersChanged(): void {
    this.showSMSTargetNotifierMessage = this.createMassNotificationInput.targetNotifiers.includes('MyCompanyName.AbpZeroTemplate.Notifications.SmsRealTimeNotifier');
  }
}
